        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid gap-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                {...register("task_quantity", {
                  required: "Task quantity is required",
                })}
                type="number"
                id="task_quantity"
            ...
            <div>
              <label htmlFor="task_image_url" className="block font1 font-medium mb-1">
                Task Image
              </label>
              <input
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-indigo-500 text-white p-3 rounded-lg font1 hover:bg-indigo-600 transition disabled:opacity-50"
          >
